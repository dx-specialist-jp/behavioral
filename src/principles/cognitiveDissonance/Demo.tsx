    ...
    <DemoShell accentHue={accentHue}>
      ...
      {stage === "result" && (
        <DemoResult title="あなたの報酬と評価の変化">
          ...
          {enjoyment > 10 - boredom ? (
            <DemoHint>
              「面白い」と書いたことで、実際の評価も少し引き上げられたかもしれません。フェスティンガーとカールスミスの1959年の実験では、退屈な作業を「面白かった」と嘘をつくよう頼まれた参加者のうち、報酬が1ドルと少なかった人ほど、後で本当に「面白かった」と思うようになりました。報酬が少ないと「お金のためについた嘘」と割り切れず、代わりに自分の気持ちの方を変えて矛盾を解消したのです。このデモでは同じ発想を、少額（1円）と高額（300円）の報酬に置き換えて再現しています。今回のあなたの報酬は{reward}円でした。
            </DemoHint>
          ) : (
            <DemoHint>
              今回は退屈度と楽しさ評価があまり変わらなかったようです。フェスティンガーの実験では、報酬が高い（20ドル）参加者は「お金のために嘘をついた」と納得できるため、態度をあまり変えずに済みました。このデモでは同じ発想を少額（1円）・高額（300円）の報酬に置き換えており、今回の報酬{reward}円は、その納得しやすさに影響したかもしれません。
            </DemoHint>
          )}
        </DemoResult>
      )}
